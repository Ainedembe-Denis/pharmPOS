      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::select('common_settings[num_to_word_format]', ['international' => __('lang_v1.international'), 'ugandan' => __('lang_v1.ugandan')], $invoice_layout->common_settings['num_to_word_format'] ?? 'international', ['class' => 'form-control', 'id' => 'word_format']); !!}
          </div>
        </div>
