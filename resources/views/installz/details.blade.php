...
@section('title', 'SolverPharmPOS Installation - Check server')

@section('content')
<div class="container">
    <div class="row">
        <h3 class="text-center">{{ config('app.name', 'SolverPharmPOS') }} Installation <small>Step 2 of 3</small></h3>
          ...
          <div class="box box-primary active">
            ...
            <div class="box-body">
              ...
              <form class="form" id="details_form" method="post" 
                ...
                <h4> License Details <small class="text-danger">Make sure to provide correct information from /codecanyon</small></h4>
                <hr/>
