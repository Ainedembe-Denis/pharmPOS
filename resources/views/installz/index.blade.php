...
@section('title', 'Welcome - SolverPharmPOS Installation')

@section('content')
<div class="container">
    
    <div class="row">
      <h3 class="text-center">{{ config('app.name', 'SolverPharmPOS') }} Installation <small>Step 1 of 3</small></h3>
          ...
          <div class="box box-primary active">
            ...
            <div class="box-body">
              <h3 class="text-success">
                Welcome to SolverPharmPOS Installation!
              </h3>
              ...
              <ol>
                ...
                <li>
                  <b>Details:</b>
                  <ul>
                    <li><b>purchase code.</b> (<a href="" target="_blank">Where Is My Purchase Code?</a>)</li>
                    <li>
                      <b>Envato Username.</b>
                    </li>
                  </ul>
