...
return [
    ...
    'tooltip_sku' => 'A stock-keeping unit (SKU), is used by retailers to identify and track its inventory, or stock. It is a scannable bar code, most often seen printed on product labels in a retail store.',
    ...
    'tooltip_columnize_taxes_heading' => 'Enter tax name for headings, heading should be present in tax name. For example headings can be: VAT, Exise duty, Withholding etc',
    ...
    'bank_code_help' => 'A unique code to identify the bank in Uganda',
    'branch' => 'Branch',
    'tax_payer_id' => 'Tax Payer ID',
    'tax_payer_id_help' => 'Tax number id of the employee - TIN',
    ...
    'amount_for_unit_rp_tooltip' => '<strong>Meaning how much the customer spent to get one reward points.</strong> <br><br> <strong>Example:</strong> If you set it as 10, then for every UGX. 10 spent by customer they will get one reward points. If the customer purchases for UGX. 1000 then they will get 100 reward points.',
    ...
    'redeem_amount_per_unit_rp_tooltip' => '<strong> It indicates the redeem amount per point.</strong> <br><br> <strong>For example:</strong>If 1 point is UGX. 1 then enter the value as 1. If 2 points is UGX. 1 then enter the value as 0.50',
    ...
    'ugandan' => 'Ugandan',
    'word_format_help' => 'In international format big numbers are represented in million, billion and trillion',
    ...
    'refresh' => 'Refresh',
    'gst_sales_report' => 'Sales report',
    'invoice_date' => 'Invoice date',
    'gstin_of_cutomer' => 'Customer Business registation No.',
    'hsn_code' => 'HSN code',
    'taxable_value' => 'Taxable value',
    'gst_purchase_report' => 'Purchase report',
    'gstin_of_supplier' => 'Supplier Business registation No.',
    'format_3' => 'Format 3',
